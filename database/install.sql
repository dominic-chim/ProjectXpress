...
-- initial values
insert into skill (skill_id, skill_name) values (1, 'management');

insert into risk_level (task_risk_level, risk_percentage) values ('Low', 100);
insert into risk_level (task_risk_level, risk_percentage) values ('Middle', 110);
insert into risk_level (task_risk_level, risk_percentage) values ('High', 120);
insert into risk_level (task_risk_level, risk_percentage) values ('Very High', 130);
